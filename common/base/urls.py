...
from .models import CountryProductStandard
...
drf_router.register(r'rest/v1/base/market-product-size-standard-size', MarketProductSizeStandardSizeViewSet, basename='market_product_size_standard_size')
