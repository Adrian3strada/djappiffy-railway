...
from .viewsets import (ProductKindViewSet, CityViewSet, SubRegionViewSet, RegionViewSet, CountryViewSet,
                       ...
                       CountryProductStandardSizeViewSet, SupplyMeasureUnitCategoryViewSet, FruitPurchasePriceCategoryViewSet)
...
drf_router.register(r'rest/v1/base/fruit-purchase-price-category', FruitPurchasePriceCategoryViewSet, basename='base_fruitpurchasepricecategoryviewset')
