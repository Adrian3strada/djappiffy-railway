...
from .viewsets import (
    ...
    PurchaseOrderSupplyViewSet, HarvestContainerViewSet
)
...
drf_router.register(r'rest/v1/catalogs/harvest-container', HarvestContainerViewSet, basename='harvest_container')
