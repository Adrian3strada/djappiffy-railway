...
from .viewsets import (
    MarketViewSet, MarketClassViewSet, VehicleViewSet, HarvestingCrewProviderViewSet,
...
drf_router.register(r'rest/v1/catalogs/market-class', MarketClassViewSet, basename='market_class')
