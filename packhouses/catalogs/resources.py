...
class PackagingResource(DehydrationResource, ExportResource):
    ...
    class Meta:
        model = Packaging
        exclude = default_excluded_fields 
        export_order = ('id', 'name', 'main_supply_kind', 'main_supply', 'main_supply_quantity', 'max_product_amount_per_package', 'market', 'product', 'product_packaging_standard', 'packaging_kind', 'inside', 'is_enabled')
