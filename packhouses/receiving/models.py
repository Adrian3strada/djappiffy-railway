...
class IncomingProduct(models.Model):
    ...
    packhouse_weight_result = models.FloatField(default=0, verbose_name=_("Packhouse Weight Result"), validators=[MinValueValidator(0.01)])
    ...
    current_kg = models.FloatField(default=0, verbose_name=_("Current Kg"),)
